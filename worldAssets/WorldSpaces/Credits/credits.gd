...
var credits_dict :Dictionary= JSON.parse_string(FileAccess.open("res://worldAssets/WorldSpaces/Credits/Credits.json", FileAccess.READ).get_as_text())
